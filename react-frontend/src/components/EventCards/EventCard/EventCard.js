...
export default function EventCard(props) {
  ...
  if (props.faculty == "chemistry") {
    ...
    icons.push(create_icon("faculty/" + "computer_science", "Faculty of computer_science"));
    ...
    icons.push(create_icon("faculty/" + "engineering", "Faculty of engineering"));
  } else if (props.faculty == "law") {
    icons.push(create_icon("faculty/" + "law", "Faculty of law"));
  } else if (props.faculty == "linguistics") {
    icons.push(create_icon("faculty/" + "linguistics", "Faculty of linguistics"));
    ...
    icons.push(create_icon("faculty/" + "mathematics", "Faculty of mathematics"));
    ...
    icons.push(create_icon("faculty/" + "veterinary_medicine", "Faculty of veterinary_medicine"));
  }
